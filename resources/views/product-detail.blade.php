...
@section('content')
    ...
    {{-- {{ dd($product_detail->image->getUrl()) }} --}}
                ...
                <div class="col-xl-6">
                    <div class="product__details-content">
                        ...
                        <div class="product-stock mb-20">
                            <h5>Availability: <span> 12 in stock</span></h5>
                        </div>
                        ...
                        <div class="product-tag-area mt-15">
                            <div class="product_info">
                                ...
                                <span class="posted_in">
                                    ...
                                    <a href="#">{{ $product_detail->category->title }}</a>
                                </span>
                ...
                <div class="tab-pane fade" id="aditional" role="tabpanel" aria-labelledby="aditional-tab">
                    <div class="product__desc-info">
                        <ul>
                            ...
                            <li>
                                <h6>Shipping</h6>
                                <span>Standard shipping: Rs 5,95</span>
                            </li>
                            <li>
                                <h6>Care Info</h6>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="product__modal-content">
                                    ...
                                    <div class="product__price">
                                        <span>Rs 109.00 – Rs 307.00</span>
                                    </div>
                                    <div class="product__modal-des mt-20 mb-15">
                                        <ul>
                                            <li><a href="#"><i class="fas fa-circle"></i> Bass and Stereo Sound.</a></li>
                                            <li><a href="#"><i class="fas fa-circle"></i> Display with 3088 x 1440 pixels
                                                    resolution.</a></li>
                                            <li><a href="#"><i class="fas fa-circle"></i> Memory, Storage & SIM: 12GB RAM,
                                                    256GB.</a></li>

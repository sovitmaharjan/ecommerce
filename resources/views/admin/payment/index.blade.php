                ...
                <div class="card">
                    <div class="card-header border-0 pt-6">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bolder fs-3 mb-1">Payment Statistics</span>
                            <span class="text-muted mt-1 fw-bold fs-7">Over {{ count($payment) }}
                                payment{{ count($payment) > 1 ? 's' : '' }}</span>
                        </h3>
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                                        ...
                                                        <div class="menu-item px-3">
                                                            <form id="form{{ $value->id }}"
                                                                action="{{ route('payment.destroy', $value->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('delete')
                                                            </form>

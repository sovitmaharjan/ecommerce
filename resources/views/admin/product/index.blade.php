                ...
                <div class="card">
                    <div class="card-header border-0 pt-6">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bolder fs-3 mb-1">Product Statistics</span>
                            <span class="text-muted mt-1 fw-bold fs-7">Over {{ count($product) }}
                                product{{ count($product) > 1 ? 's' : '' }}</span>
                        </h3>

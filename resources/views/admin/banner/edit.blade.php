    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            <div id="kt_content_container" class="container-xxl">
                <form id="banner_form" class="form d-flex flex-column flex-lg-row" method="POST" action="{{ route('banner.update', $banner->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('patch')
                    <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body text-center pt-0">
                                <div class="image-input image-input-outline image-input-empty" data-kt-image-input="true" style="background-image: ">
                                    <div class="image-input-wrapper w-225px h-125px bgi-position-center" style="background-size: 75%; background-image: url({{ $banner->image ? $banner->image->getUrl() : '' }})"></div>
                        ...
                        <div class="card card-flush py-4">
                            <div class="card-header">
                                ...
                                <div class="card-toolbar">
                                    <div class="rounded-circle bg-{{ $banner->status === 1 ? 'success' : 'danger' }} w-15px h-15px" id="kt_ecommerce_add_banner_status"></div>
                                </div>
                            </div>
                            <div class="card-body pt-0">
                                <select class="form-select mb-2" name="status" data-control="select2" data-hide-search="true" data-placeholder="Select an option" id="kt_ecommerce_add_banner_status_select" required>
                                    <option></option>
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                <div class="mb-10 fv-row">
                                    ...
                                    <input type="text" name="title" class="form-control mb-2" placeholder="Banner name" value="{{ $banner->title }}" required/>
                                    <div class="text-muted fs-7">A banner name is required and recommended to be unique.</div>
                                </div>
                                <div>
                                    <label class="form-label">Description</label>
                                    <textarea name="description" class="form-control mb-2" id="textarea_description" rows="5">{!! $banner->description !!}</textarea>

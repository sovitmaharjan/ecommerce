                        ...
                        <div class="tab-pane fade show active" id="kt_ecommerce_settings_general" role="tabpanel">
                            <div class="card card-flush">
                                ...
                                <div class="card-body pt-0">
                                    <form id="general_setting" class="form" method="POST" action="{{ route('general-setting.update', $general_setting->id) }}" enctype="multipart/form-data">
                                        @csrf
                                        @method('patch')
                                        <div class="row fv-row mb-7">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control form-control-solid" name="website_name"
                                                    value="{{ old('website_name') ?? $general_setting->website_name }}" required />
                                            </div>
                                        </div>
                                        <div class="row fv-row mb-7">
                                            <div class="col-md-3 text-md-end">
                                            ...
                                            <div class="col-md-9">
                                                <div class="image-input image-input-outline image-input-empty"
                                                    ...
                                                    <div class="image-input-wrapper w-125px h-125px bgi-position-center" style="background-size: 75%; background-image: url({{ $general_setting->getUrlType('logo') ?? asset('assets/admin/media/svg/files/blank-image.svg') }})"></div>
                                                    <label
                                        ...
                                        <div class="row fv-row mb-7">
                                            ...
                                            <div class="col-md-9">
                                                <div class="image-input image-input-outline image-input-empty"
                                                    data-kt-image-input="true"
                                                    style="background-image: url({{ asset('assets/admin/media/svg/files/blank-image.svg') }})">
                                                    <div class="image-input-wrapper w-125px h-125px bgi-position-center" style="background-size: 75%; background-image: url({{ $general_setting->getUrlType('favicon') ?? asset('assets/admin/media/svg/files/blank-image.svg') }})"></div>
                                                    <label
                                                        class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow"
                                                        data-kt-image-input-action="change" data-bs-toggle="tooltip"
                                        ...
                                        <div class="row fv-row mb-7">
                                            ...
                                            <div class="col-md-9">
                                                <input type="email" class="form-control form-control-solid"
                                                    name="email" value="{{ old('email') ?? $general_setting->email }}" required/>
                                            </div>
                                        </div>
                                        <div class="row fv-row mb-7">
                                            <div class="col-md-3 text-md-end">
                                            ...
                                            <div class="col-md-9">
                                                <textarea class="form-control form-control-solid" name="address" required>{{ old('address') ?? $general_setting->address }}</textarea>
                                            </div>
                                        </div>
                                        <div class="row fv-row mb-7">
                                            <div class="col-md-3 text-md-end">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control form-control-solid" name="mobile"
                                                    value="{{ old('mobile') ?? $general_setting->mobile }}" required />
                                            </div>
                                        </div>
                                        <div class="row fv-row mb-7">
                                            <div class="col-md-3 text-md-end">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control form-control-solid"
                                                    name="phone" value="{{ old('phone') ?? $general_setting->phone }}" />
                                            </div>
                                        </div>
                                        <div class="row fv-row mb-7">
                                            <div class="col-md-3 text-md-end">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control form-control-solid"
                                                    name="meta_title" value="{{ old('meta_title') ?? $general_setting->meta_title }}" />
                                            </div>
                                        </div>
                                        <div class="row fv-row mb-7">
                                            <div class="col-md-3 text-md-end">
                                            ...
                                            <div class="col-md-9">
                                                <textarea class="form-control form-control-solid" name="meta_description">{{ old('meta_description') ?? $general_setting->meta_description }}</textarea>
                                            </div>
                                        </div>
                                        <div class="row fv-row mb-7">
                                            <div class="col-md-3 text-md-end">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control form-control-solid"
                                                    name="meta_keyword" value="{{ old('meta_keyword') ?? $general_setting->meta_keyword }}"
                                        ...
                                        <div class="row fv-row mb-7">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control form-control-solid" name="facebook"
                                                    value="{{ old('facebook') ?? $general_setting->facebook }}" />
                                            </div>
                                        </div>
                                        <div class="row fv-row mb-7">
                                            <div class="col-md-3 text-md-end">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control form-control-solid" name="twitter"
                                                    value="{{ old('twitter') ?? $general_setting->twitter }}" />
                                            </div>
                                        </div>
                                        <div class="row fv-row mb-7">
                                            <div class="col-md-3 text-md-end">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control form-control-solid" name="instagram"
                                                    value="{{ old('instagram') ?? $general_setting->instagram }}" />
                                            </div>
                                        </div>
                                        <div class="row fv-row mb-7">
                                            <div class="col-md-3 text-md-end">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control form-control-solid" name="linkedin"
                                                    value="{{ old('linkedin') ?? $general_setting->linkedin }}" />
                                            </div>
                                        </div>
                                        <div class="row fv-row mb-7">
                                            <div class="col-md-3 text-md-end">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control form-control-solid" name="youtube"
                                                    value="{{ old('youtube') ?? $general_setting->youtube }}" />
                                            </div>
                                        </div>
                                        <div class="row fv-row mb-7">
                                            <div class="col-md-3 text-md-end">
                                            ...
                                            <div class="col-md-9">
                                                <textarea class="form-control form-control-solid" name="google_map">{{ old('google_map') ?? $general_setting->google_map }}</textarea>
                                            </div>
                                        </div>
                                        {{-- <div class="row">
                                            <div class="col-md-9 offset-md-3">

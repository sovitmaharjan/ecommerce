                                    ...
                                    <div id="key">
                                        <div class="form-group">
                                            <div data-repeater-list="key">
                                                {{-- {{ dd(json_decode($payment->key)) }} --}}
                                                @foreach (json_decode($payment->key) as $key => $value)
                                                <div data-repeater-item>
                                                    <div class="form-group row">
                                                        <div class="col-md-4">
                                                            <label class="form-label required">Key Name:</label>
                                                            <input type="text" name="key_name" class="form-control mb-2 mb-md-0" value="{{ $value->key_name }}" required />
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="form-label required">Key Value:</label>
                                                            <textarea name="key_value" class="form-control mb-2" rows="3" required>{{ $value->key_value }}</textarea>
                                                        </div>
                                                        <div class="col-md-2">

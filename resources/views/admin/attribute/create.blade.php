        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            <div id="kt_content_container" class="container-xxl">
                <form id="attribute_form" class="form d-flex flex-column flex-lg-row" method="POST"
                    action="{{ route('attribute.store') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                <div class="mb-10 fv-row">
                                    ...
                                    <input type="text" name="title" class="form-control mb-2" placeholder="Attribute name"
                                        value="{{ old('title') }}" required/>
                                    <div class="text-muted fs-7">A attribute name is required and recommended to be unique.
                                    </div>
                                    @error('title')
                                        <div class="fv-plugins-message-container invalid-feedback">
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="{{ route('attribute.index') }}" id="kt_ecommerce_add_product_cancel"

        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{ $pageName ?? '' }}</h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
                                ...
                                <div class="mb-10">
                                    ...
                                    <div>
                                        <select class="form-select form-select-solid select2-hidden-accessible"
                                            ...
                                            data-dropdown-parent="#kt_menu_6204d1c45d80a" data-allow-clear="true"
                                            data-select2-id="select2-data-7-jwi9" tabindex="-1" aria-hidden="true">
                                            <option data-select2-id="select2-data-9-pu0x"></option>
                                            <option value="1">Approved</option>
                                            <option value="2">Pending</option>
                                            <option value="2">In Process</option>
                                            <option value="2">Rejected</option>
                                        </select><span class="select2 select2-container select2-container--bootstrap5"
                                            dir="ltr" data-select2-id="select2-data-8-08xv" style="width: 100%;"><span
                                                class="selection"><span
                                                    class="select2-selection select2-selection--single form-select form-select-solid"
                                                    role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                    aria-disabled="false" aria-labelledby="select2-k0p0-container"
                                                    aria-controls="select2-k0p0-container"><span
                                                        class="select2-selection__rendered" id="select2-k0p0-container"
                                        ...
                                        <table class="table align-middle table-row-dashed gy-5"
                                            ...
                                            <tbody class="fs-6 fw-bold text-gray-600">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#"
                                                            class="text-gray-600 text-hover-primary mb-1">6521-8143</a>
                                                    </td>
                                                    <!--end::Invoice=-->
                                                    <!--begin::Status=-->
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#"
                                                            class="text-gray-600 text-hover-primary mb-1">5268-5354</a>
                                                    </td>
                                                    <!--end::Invoice=-->
                                                    <!--begin::Status=-->
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#"
                                                            class="text-gray-600 text-hover-primary mb-1">7692-6689</a>
                                                    </td>
                                                    <!--end::Invoice=-->
                                                    <!--begin::Status=-->
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#"
                                                            class="text-gray-600 text-hover-primary mb-1">4242-8507</a>
                                                    </td>
                                                    <!--end::Invoice=-->
                                                    <!--begin::Status=-->
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#"
                                                            class="text-gray-600 text-hover-primary mb-1">3673-9850</a>
                                                    </td>
                                                    <!--end::Invoice=-->
                                                    <!--begin::Status=-->
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#"
                                                            class="text-gray-600 text-hover-primary mb-1">3299-2373</a>
                                                    </td>
                                                    <!--end::Invoice=-->
                                                    <!--begin::Status=-->
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#"
                                                            class="text-gray-600 text-hover-primary mb-1">2654-5377</a>
                                                    </td>
                                                    <!--end::Invoice=-->
                                                    <!--begin::Status=-->
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#"
                                                            class="text-gray-600 text-hover-primary mb-1">3267-6798</a>
                                                    </td>
                                                    <!--end::Invoice=-->
                                                    <!--begin::Status=-->
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#"
                                                            class="text-gray-600 text-hover-primary mb-1">3031-3414</a>
                                                    </td>
                                                    <!--end::Invoice=-->
                                                    <!--begin::Status=-->
                                                    <td>
                                                    ...
                                                    <div class="flex-equal me-5">
                                                        <table class="table table-flush fw-bold gy-1">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-gray-800">**** 7483</td>
                                                            </tr>
                                                            <tr>
                                                ...
                                                <div class="d-flex flex-wrap py-5">
                                                    ...
                                                    <div class="flex-equal me-5">
                                                        <table class="table table-flush fw-bold gy-1">
                                                            ...
                                                            <tr>
                                                                <td class="text-muted min-w-125px w-125px">Number</td>
                                                                <td class="text-gray-800">**** 8756</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="text-muted min-w-125px w-125px">Expires</td>
                                                ...
                                                <div class="d-flex flex-wrap py-5">
                                                    ...
                                                    <div class="flex-equal me-5">
                                                        <table class="table table-flush fw-bold gy-1">
                                                            ...
                                                            <tr>
                                                                <td class="text-muted min-w-125px w-125px">Number</td>
                                                                <td class="text-gray-800">**** 2427</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="text-muted min-w-125px w-125px">Expires</td>
                                            ...
                                            <table
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <!--end::Badge=-->
                                                        <!--begin::Status=-->
                                                        <td>POST /v1/invoices/in_4942_9388/payment</td>
                                                        <!--end::Status=-->
                                                        <!--begin::Timestamp=-->
                                                        <td class="pe-0 text-end min-w-200px">22 Sep 2021, 9:23 pm</td>
                                                        <!--end::Timestamp=-->
                                                    </tr>
                                                    <!--end::Table row-->
                                                    <!--begin::Table row-->
                                                    <tr>
                                                        ...
                                                        <!--end::Badge=-->
                                                        <!--begin::Status=-->
                                                        <td>POST /v1/invoices/in_1699_8182/payment</td>
                                                        <!--end::Status=-->
                                                        <!--begin::Timestamp=-->
                                                        <td class="pe-0 text-end min-w-200px">24 Jun 2021, 5:20 pm</td>
                                                        <!--end::Timestamp=-->
                                                    </tr>
                                                    <!--end::Table row-->
                                                    <!--begin::Table row-->
                                                    <tr>
                                                        ...
                                                        <!--end::Badge=-->
                                                        <!--begin::Status=-->
                                                        <td>POST /v1/invoice/in_3331_4031/invalid</td>
                                                        <!--end::Status=-->
                                                        <!--begin::Timestamp=-->
                                                    ...
                                                    <tr>
                                                        ...
                                                        <!--end::Badge=-->
                                                        <!--begin::Status=-->
                                                        <td>POST /v1/invoice/in_8865_4183/invalid</td>
                                                        <!--end::Status=-->
                                                        <!--begin::Timestamp=-->
                                                        <td class="pe-0 text-end min-w-200px">22 Sep 2021, 2:40 pm</td>
                                                        <!--end::Timestamp=-->
                                                    </tr>
                                                    <!--end::Table row-->
                                                    <!--begin::Table row-->
                                                    ...
                                                    <tr>
                                                        ...
                                                        <!--end::Badge=-->
                                                        <!--begin::Status=-->
                                                        <td>POST /v1/invoices/in_8380_4765/payment</td>
                                                        <!--end::Status=-->
                                                        <!--begin::Timestamp=-->
                                                    ...
                                                    <tr>
                                                        ...
                                                        <!--end::Badge=-->
                                                        <!--begin::Status=-->
                                                        <td>POST /v1/invoices/in_5080_3949/payment</td>
                                                        <!--end::Status=-->
                                                        <!--begin::Timestamp=-->
                                                        <td class="pe-0 text-end min-w-200px">22 Sep 2021, 5:20 pm</td>
                                                        <!--end::Timestamp=-->
                                                    </tr>
                                                    <!--end::Table row-->
                                                    <!--begin::Table row-->
                                                    <tr>
                                                        ...
                                                        <!--end::Badge=-->
                                                        <!--begin::Status=-->
                                                        <td>POST /v1/customer/c_61cf08b14b4bf/not_found</td>
                                                        <!--end::Status=-->
                                                        <!--begin::Timestamp=-->
                                                    ...
                                                    <tr>
                                                        ...
                                                        <!--end::Badge=-->
                                                        <!--begin::Status=-->
                                                        <td>POST /v1/invoices/in_2051_8538/payment</td>
                                                        <!--end::Status=-->
                                                        <!--begin::Timestamp=-->
                                        ...
                                        <table class="table align-middle table-row-dashed fs-6 text-gray-600 fw-bold gy-5"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <!--end::Event=-->
                                                    <!--begin::Timestamp=-->
                                                    <td class="pe-0 text-gray-600 text-end min-w-200px">25 Jul 2021, 11:05
                                                        am</td>
                                                    <!--end::Timestamp=-->
                                                </tr>
                                                <!--end::Table row-->
                                                ...
                                                <tr>
                                                    ...
                                                    <!--end::Event=-->
                                                    <!--begin::Timestamp=-->
                                                    <td class="pe-0 text-gray-600 text-end min-w-200px">20 Dec 2021, 5:30
                                                        pm</td>
                                                    <!--end::Timestamp=-->
                                                </tr>
                                                <!--end::Table row-->
                                                ...
                                                <tr>
                                                    ...
                                                    <!--end::Event=-->
                                                    <!--begin::Timestamp=-->
                                                    <td class="pe-0 text-gray-600 text-end min-w-200px">05 May 2021, 10:10
                                                        pm</td>
                                                    <!--end::Timestamp=-->
                                                </tr>
                                                <!--end::Table row-->
                                                ...
                                                <tr>
                                                    ...
                                                    <!--end::Event=-->
                                                    <!--begin::Timestamp=-->
                                                    <td class="pe-0 text-gray-600 text-end min-w-200px">24 Jun 2021, 6:05
                                                        pm</td>
                                                    <!--end::Timestamp=-->
                                                </tr>
                                                <!--end::Table row-->
                                                ...
                                                <tr>
                                                    ...
                                                    <!--end::Event=-->
                                                    <!--begin::Timestamp=-->
                                                    <td class="pe-0 text-gray-600 text-end min-w-200px">20 Dec 2021, 11:30
                                                        am</td>
                                                    <!--end::Timestamp=-->
                                                </tr>
                                                <!--end::Table row-->
                                                ...
                                                <tr>
                                                    ...
                                                    <!--end::Event=-->
                                                    <!--begin::Timestamp=-->
                                                    <td class="pe-0 text-gray-600 text-end min-w-200px">22 Sep 2021, 8:43
                                                        pm</td>
                                                    <!--end::Timestamp=-->
                                                </tr>
                                                <!--end::Table row-->
                                                ...
                                                <tr>
                                                    ...
                                                    <!--end::Event=-->
                                                    <!--begin::Timestamp=-->
                                                    <td class="pe-0 text-gray-600 text-end min-w-200px">20 Dec 2021, 9:23
                                                        pm</td>
                                                    <!--end::Timestamp=-->
                                                </tr>
                                                <!--end::Table row-->
                                                ...
                                                <tr>
                                                    ...
                                                    <!--end::Event=-->
                                                    <!--begin::Timestamp=-->
                                                    <td class="pe-0 text-gray-600 text-end min-w-200px">20 Jun 2021, 5:30
                                                        pm</td>
                                                    <!--end::Timestamp=-->
                                                </tr>
                                                <!--end::Table row-->
                                                ...
                                                <tr>
                                                    ...
                                                    <!--end::Event=-->
                                                    <!--begin::Timestamp=-->
                                                    <td class="pe-0 text-gray-600 text-end min-w-200px">05 May 2021, 6:05
                                                        pm</td>
                                                    <!--end::Timestamp=-->
                                                </tr>
                                                <!--end::Table row-->
                                                ...
                                                <tr>
                                                    ...
                                                    <!--end::Event=-->
                                                    <!--begin::Timestamp=-->
                                                    <td class="pe-0 text-gray-600 text-end min-w-200px">05 May 2021, 9:23
                                                        pm</td>
                                                    <!--end::Timestamp=-->
                                                </tr>
                                                <!--end::Table row-->
                                ...
                                <div class="card mb-6 mb-xl-9">
                                    ...
                                    <div class="card-body py-0">
                                        <div class="fs-5 fw-bold text-gray-500 mb-4">Last 30 day earnings calculated. Apart
                                            from arranging the order of topics.</div>
                                        <!--begin::Left Section-->

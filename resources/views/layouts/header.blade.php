                    ...
                    <div class="col-xl-4 col-lg-5 col-md-8 col-sm-8">
                        <div class="header-action">
                            <div class="block-userlink">
                                <a class="icon-link" href="{{ route('customer.login') }}">
                                        ...
                                        <ul>
                                                    ...
                                                    <div class="cart__inner d-flex">
                                                        <div class="cart__thumb">
                                                            <a href="product-details.html">
                                                                <img src="{{ asset('assets/img/cart/20.jpg') }}') }}"
                                                                    alt="">
                                                            </a>
                                                        </div>
                                            ...
                                            <li>
                                                <div
                                                    ...
                                                    <h6>Subtotal</h6>
                                                    <span class="cart__sub-total">Rs 255.00</span>
                                                </div>
                                            </li>
                                            <li>
            ...
            <div class="row g-0 align-items-center">
                            ...
                            <div class="cat__menu">
                                <nav id="mobile-menu" style="display: block;">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="shop.html">Cosmetics <i class="far fa-angle-down"></i></a>

                                        </li>

                                        <li><a href="shop.html">Groceries</a></li>
                                        <li><a href="shop.html">Shoes Accessories</a></li>
                ...
                <div class="col-lg-3 col-md-6 col-9">
                    <div class="shopeing-text text-sm-end">
                        <p>Spend Rs 120 more and get free shipping!</p>
                    </div>
                </div>
            </div>
        </div>
